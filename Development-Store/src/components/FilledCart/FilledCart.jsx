		...
		<>
			<section className="p-6">
				...
				<section className="flex justify-around items-center mt-5">
					<button className="px-10 py-2 bg-slate-400 font-bold rounded-xl hover:bg-slate-600 hover:cursor-pointer hover:scale-105 transition delay-150 duration-300 ease-in-out">
						Clear Cart
					</button>
